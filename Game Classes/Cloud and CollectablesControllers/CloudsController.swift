...
class CloudsController {
    ...
    func shuffle(cloudsLetArray: [SKSpriteNode]) -> [SKSpriteNode] {
        
        var cloudsArray = cloudsLetArray
        
        for i in stride(from: cloudsArray.count - 1,to: 0, by: -1) { // > 0
    ...
    func createClouds() -> [SKSpriteNode] {
        ...
        clouds = shuffle(cloudsLetArray: clouds)
        return clouds
    }
